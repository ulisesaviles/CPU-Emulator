...
class CPU:
    def __init__(self, rom):
        ...
        self.teamMembers = ["Aviles Ulises",
                            "Cruz Elian", "Silva Abner", "René Nuñez"]
        self.clock = False
        self.colorPallete = {
            "yellow": "\033[1;33;40m",
            "white": "\033[1;37;40m",
        ...
        self.romMemory = rom
        # If the register doesn't contain an address in the data part, the fourth bit should be True.
        self.ramMemory = [[False for _ in range(8)] for _ in range(16)]
        # e.g.: ramMemory[0][3]=True is data, ramMemory[0][3]=False is an address
        self.ramString = ["00", "00", "00", "00", "00", "00", "00",
        ...
        # This has the same format for the fourth bit as explained on lines 34 & 35
        self.mdrData = [False, False, False, False, False, False, False, False]
        # It's divided because of the separation needed between opcode and plain data an # tag represents a raw data, a blank space is an address.
        self.mdrDataStr = ["00", "00", "#"]
        # I've decreased the bus width of the MIR register because I needed to use an extra bit for determining wheter the fetched data contains
        self.mirData = [False, False, False]
    ...
    def printCpu(self):
        ...
        print("              {}{}              {}              {}              {}\n{}##################################################################################################################\n#                                               >>{}CPU EMULATOR{}<<	                                         #\n#                                                                                                                #\n#                 {}_______________                {}_______________                {}_______________                  {}#\n#                {}|    COUNTER    |              {}|      MAR      |              {}|      RAM      |                 {}#\n#                {}|      {}       |              {}|      {}       |              {}|               |                 {}#\n#                {}|_______________|              {}|_______________|              {}| {}  {} {}  {} |                 {}#\n#                                                                              {}|               |                 {}#\n#                                                                              {}| {}  {} {}  {} |                 {}#\n#                                       {}_______________     {}_______________    {}|               |                 {}#\n#                     {}(Clock) {}        {}|      MIR      |   {}|      MDR      |   {}| {}  {} {}  {} |                 {}#\n#                                      {}|       {}      |   {}|     {}     |   {}|               |                 {}#\n#                                      {}|_______________|   {}|_______________|   {}| {}  {} {}  {} |                 {}#\n#               {}_______      _______                                           {}|               |                 {}#\n#               {}\      \    /      /             {}__________________            {}|_______________|                 {}#\n#                {}\      \  /      /             {}|                  |                                             {}#\n#                 {}\      \/      /              {}|                  |                                             {}#\n#                  {}\    ALU     /               {}|   CONTROL UNIT   |                                             {}#\n#                   {}\__________/                {}|                  |                                             {}#\n#                   {}____________                {}|__________________|                                             {}#\n#                  {}| Acumulator |                                                                                {}#\n#                  {}|     {}     |                                                                                {}#\n#                  {}|____________|                                                                                {}#\n#                                                                                                                #\n##################################################################################################################{}"
              .format(self.colorPallete[self.componentColors["team-members"]], self.teamMembers[0], self.teamMembers[1], self.teamMembers[2], self.teamMembers[3],
                      self.colorPallete[self.componentColors["border"]], self.colorPallete[self.componentColors["title"]
                                                                                           ], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["counter"]], self.colorPallete[self.componentColors["mar"]
                                                                                            ], self.colorPallete[self.componentColors["ram"]], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["counter"]], self.colorPallete[self.componentColors["mar"]
                                                                                            ], self.colorPallete[self.componentColors["ram"]], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["counter"]], self.counterCountStr, self.colorPallete[self.componentColors["mar"]
                                                                                                                  ], self.marMemoryDirectionStr, self.colorPallete[self.componentColors["ram"]], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["counter"]], self.colorPallete[self.componentColors["mar"]], self.colorPallete[self.componentColors["ram"]
                                                                                                                                            ], self.ramString[0], self.ramString[1], self.ramString[2], self.ramString[3], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["ram"]
                                        ], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["ram"]], self.ramString[4], self.ramString[
                          5], self.ramString[6], self.ramString[7], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["mir"]], self.colorPallete[self.componentColors["mdr"]
                                                                                        ], self.colorPallete[self.componentColors["ram"]], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["clock"]], clockString, self.colorPallete[self.componentColors["mir"]], self.colorPallete[self.componentColors["mdr"]
                                                                                                                                                       ], self.colorPallete[self.componentColors["ram"]], self.ramString[8], self.ramString[9], self.ramString[10], self.ramString[11], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["mir"]], self.mirDataStr, self.colorPallete[self.componentColors["mdr"]], self.mdrDataStr[0] +
                      self.mdrDataStr[2]+self.mdrDataStr[1], self.colorPallete[self.componentColors["ram"]
                                                                               ], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["mir"]], self.colorPallete[self.componentColors["mdr"]], self.colorPallete[self.componentColors["ram"]
                                                                                                                                        ], self.ramString[12], self.ramString[13], self.ramString[14], self.ramString[15], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["alu"]], self.colorPallete[self.componentColors["ram"]
                                                                                        ], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["alu"]], self.colorPallete[self.componentColors["control-unit"]
                                                                                        ], self.colorPallete[self.componentColors["ram"]], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["alu"]], self.colorPallete[self.componentColors["control-unit"]
                                                                                        ], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["alu"]], self.colorPallete[self.componentColors["control-unit"]
                      ...
                      self.colorPallete[self.componentColors["acumulator"]], self.colorPallete[self.componentColors["control-unit"]
                                                                                               ], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["acumulator"]
                                        ], self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["acumulator"]
                                        ], self.acumulatorString, self.colorPallete[self.componentColors["border"]],
                      self.colorPallete[self.componentColors["acumulator"]
                                        ], self.colorPallete[self.componentColors["border"]],
    ...
    def fullAdder_(self, a, b, cin):
        ...
        # returns [cout, sum]
        return [a and b or a != b and cin, (a != b) != cin]
    ...
    def adderSubstractor_(self, a, b, substraction):
        ...
        firstFullAdder = self.fullAdder_(
            a[3], b[3] != substraction, substraction)
        secondFullAdder = self.fullAdder_(
            a[2], b[2] != substraction, firstFullAdder[0])
        thirdFullAdder = self.fullAdder_(
            a[1], b[1] != substraction, secondFullAdder[0])
        fourthFullAdder = self.fullAdder_(
            a[0], b[0] != substraction, thirdFullAdder[0])
    ...
    def alu(self, s1, s0, b):
        ...
        if (s1):  # This selector chooses whether we'll use logic or arithmetic operations, if true, logic ops are chosen, otherwise arithmetic are chosen.
            if (not s0):  # Bitwise and, selectors: 10
                self.acumulator(
                    True, [a[0] and b[0], a[1] and b[1], a[2] and b[2], a[3] and b[3]])
            else:  # Bitwise or, Selectors: 11
                # True, [a[0] or b[0], a[1] or b[1], a[2] or b[2], a[3] or b[3]]
                self.acumulator(
                    True, [a[0] or b[0], a[1] or b[1], a[2] or b[2], a[3] or b[3]])
        else:
            # bitwise sum or substraction deppending on s0, 1->SUB, 0->ADD
            self.acumulator(True, self.adderSubstractor_(a, b, s0))
    ...
    def acumulator(self, write, data):
        ...
        if (write):
            ...
            self.acumulatorString = str(
                self.binaryToDec_(self.acumulatorData, 4))
    ...
    def counter(self, enableCount):
        ...
        if (enableCount):
            # Sum 1 to the counter count using the adder/substractor
            self.counterCount = self.adderSubstractor_(
                self.counterCount, [False, False, False, True], False)
    ...
    def mar(self, memoryDirection, s3, writeOnMemory, readDirect):
        ...
        self.marMemoryDirectionStr = str(
            self.binaryToDec_(self.marMemoryDirection, 4))
        ...
        if (not writeOnMemory):
            if (s3):  # this tells us wheter we're receiving from Program Counter or the Control Unit, if True, we have to return a value to the CU, else it has to keep the fetch cycle to MDR
                if (readDirect):
                    dataFetched = self.ram(
                        self.marMemoryDirection, False, "dont care")
    ...
    def mdr(self, data, s3, writeOnRAM):
        ...
        # This just writes a # tag if true, indicating it contains raw data, if not, it writes a blank space
        self.mdrDataStr[2] = "#" if self.mdrData[3] == True else " "
    ...
    def controlUnit(self, dataIn):
        ...
        def decoder(rawData):
            ...
            #################################################### IMPORTANT ###################################################
            # IMPORTANT: the opcode only takes the first 3 bits from left to right
            instructionFetched = rawData[:3]
            self.mir(instructionFetched)
            # The ALU instructions have a zero in the first bit of the opcode, namely it should be False to be considered an ALU operation
            if (not instructionFetched[0]):
        ...
        def dataTransferInstructions(rawData):
            ...
            # MOVAR, it works the same as a LDA on direct mode
            elif (not instructionFetched[1] and instructionFetched[2]):
                self.componentColors["control-unit"] = "white"
                dataFetched = self.mar(dataFetched, True, False, True)[-4:]
                setColorsBefore_()
                self.acumulator(True, dataFetched)
                ...
                dataAcc.append(True)
                # Since dataAcc has only 4-bit width, we need to append to it 4 zeros bits at the beggingg of it
                for i in self.acumulator(False, "Don't care"):
                    dataAcc.append(i)
                self.mdr(dataAcc, True, True)
                self.mar(dataFetched, True, True, False)
            # NOP                      #The s3 parameter is a don't care
            elif (instructionFetched[1] and instructionFetched[2]):
                self.componentColors = {
                    "team-members": "white",
                    "border": "yellow",
                    "title": "white",
        ...
        def aluInstructions(rawData):
            ...
            if (not rawData[3]):  # if rawData[3] is on False, the data is a reference to a memory address and direct MODE its invoked (it does another fetch cycle)
                self.componentColors["control-unit"] = "white"
                # Goes to mar and sends it the address fetched in the last cycle, sets the reference from CU as true and false for writting
                dataFetched = self.mar(dataFetched, True, False, True)[-4:]
